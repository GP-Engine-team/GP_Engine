...
class DefaultInspectPropertyRule : public kodgen::MacroPropertyCodeGen
{
protected:
    inline static std::string propertyName = "DefaultInspect";
    ...
    std::string generateDefaultInspectFunction(const kodgen::StructClassInfo& entity, kodgen::Property const& property,
...
public:
    DefaultInspectPropertyRule() noexcept;
};