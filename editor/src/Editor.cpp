...
namespace Editor
{
	...
	void Editor::renderInspector(GameObject& gameObject) const
	{
	...
	GameObject* Editor::recursifSceneGraphNode(GameObject& gameObject, int idElem) const
	{
		...
		else
		{
			...
			if (nodeOpen)
			{
				...
				{
					selectedGameObject = recursifSceneGraphNode(*child.get(), ++idElem);
				}
				ImGui::TreePop();
			}
		}
	...
	void Editor::renderSceneGraph(Scene& scene) const
	{
		ImGui::Begin("Scene Graph");

		GameObject* selectedGameObject = recursifSceneGraphNode(scene.world);
