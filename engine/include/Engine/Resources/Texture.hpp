...
namespace Engine::Resources
{
    ...
    class Texture
    {
        ...
        int             m_w, m_h;
        unsigned char   m_comp; //RGB = 3 / RGBA = 4
        ...
        const unsigned char* 	getPixels	() const 	{return m_pixels;} //read only
        unsigned char* 		    getPixels	() 			{return m_pixels;} //read/write
        ...
        Size getSize() const noexcept {return {m_w, m_h};}
