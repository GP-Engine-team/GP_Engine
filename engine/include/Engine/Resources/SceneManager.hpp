...
#include <memory>
 ...
 namespace Engine::Resources
 {
    ...
    class SceneManager
    {
        ...
        void loadNewScene(const std::string& sceneID, ESceneGraphManagement sceneGraphloadType = ESceneGraphManagement::REPLACE, EResourceManagement resourcesloadType = EResourceManagement::RECYCLING)
        {
